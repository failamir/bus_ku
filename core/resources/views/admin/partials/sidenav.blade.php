            ...
            <ul class="sidebar__menu">
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.vehicle.ticket.pending') }} ">
                                <a href="{{ route('admin.vehicle.ticket.pending') }}" class="nav-link">
                                    ...
                                    @if ($pending_vehicle_ticket)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{ $pending_vehicle_ticket }}</span>
                                    @endif
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.fleet*', 3) }}">
                        ...
                        <span class="menu-title">@lang('Manage Kendaraan')</span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.fleet*', 2) }} ">
                        <ul>
                            ...
                            <li
                                class="sidebar-menu-item  {{ menuActive(['admin.fleet.vehicles', 'admin.fleet.vehicles.search']) }}">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.trip*', 2) }}">
                        <ul>
                            <li
                                class="sidebar-menu-item {{ menuActive(['admin.trip.route', 'admin.trip.route.create', 'admin.trip.route.edit']) }} ">
                            ...
                            <li
                                class="sidebar-menu-item {{ menuActive(['admin.trip.ticket.price', 'admin.trip.ticket.price.create', 'admin.trip.ticket.price.edit']) }} ">
